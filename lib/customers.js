...
function getCustomers (opts) {
  ...
  const standardizeCustomer = customer => _.reduce((acc, value) => acc.then(value), Promise.resolve(customer), [
    assignCustomerData,
    getCustomInfoRequestsData,
    camelizeDeep,
    formatSubscriberInfo,
    getExternalCustomerData
  ])
