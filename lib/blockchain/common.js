...
const BINARIES = {
  ...
  ETH: {
    url: 'https://gethstore.blob.core.windows.net/builds/geth-linux-amd64-1.13.12-02eb36af.tar.gz',
    dir: 'geth-linux-amd64-1.13.12-02eb36af'
  },
  ZEC: {
    url: 'https://z.cash/downloads/zcash-5.8.0-linux64-debian-bullseye.tar.gz',
    dir: 'zcash-5.8.0/bin'
  },
  DASH: {
    ...
    url: 'https://github.com/dashpay/dash/releases/download/v20.0.4/dashcore-20.0.4-x86_64-linux-gnu.tar.gz',
    dir: 'dashcore-20.0.4/bin'
  },
  LTC: {
