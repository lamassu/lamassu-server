...
const BINARIES = {
  ...
  ETH: {
    url: 'https://gethstore.blob.core.windows.net/builds/geth-linux-amd64-1.9.13-cbc4ac26.tar.gz',
    dir: 'geth-linux-amd64-1.9.13-cbc4ac26'
  },
  ZEC: {
    url: 'https://z.cash/downloads/zcash-2.1.2-linux64-debian-jessie.tar.gz',
    dir: 'zcash-2.1.2/bin'
  },
  DASH: {
  ...
  BCH: {
    url: 'https://download.bitcoinabc.org/0.21.4/linux/bitcoin-abc-0.21.4-x86_64-linux-gnu.tar.gz',
    dir: 'bitcoin-abc-0.21.4/bin',
