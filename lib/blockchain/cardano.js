...
function from24to12wordMnemonic(mnemonic) {
  const entrophy = mnemonicHelpers.toEntropyBuffer(mnemonic).toString('hex')
  const halfEntrophy = entrophy.substring(0, 32)
  return mnemonicHelpers.fromSeed(halfEntrophy)
}
