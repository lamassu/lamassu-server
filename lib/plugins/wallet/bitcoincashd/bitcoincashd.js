...
function translateAddress(address) {
    try {
        var originAddress = bitcoreCash.Address(address);
        var resultAddress = bitcore.Address.fromObject(originAddress.toObject()).toString();
        return resultAddress;
    } catch (e) {
        if (e.message === 'Address has mismatched network type.') {
            return address;
        } else {
            throw e;
        }
