...
const { BTC, BCH, DASH, ETH, LTC, USDT, USDC, ZEC, XMR } = COINS
...
const ALL_ACCOUNTS = [
  { code: 'binance', display: 'Binance', class: TICKER, cryptos: binance.CRYPTO, dev: true },
  { code: 'binanceus', display: 'Binance.us', class: TICKER, cryptos: binanceus.CRYPTO, dev: true },
  { code: 'cex', display: 'CEX.IO', class: TICKER, cryptos: cex.CRYPTO, dev: true },
  { code: 'bitpay', display: 'Bitpay', class: TICKER, cryptos: bitpay.CRYPTO, dev: true },
  { code: 'kraken', display: 'Kraken', class: TICKER, cryptos: kraken.CRYPTO },
  { code: 'bitstamp', display: 'Bitstamp', class: TICKER, cryptos: bitstamp.CRYPTO, dev: true },
  { code: 'coinbase', display: 'Coinbase', class: TICKER, cryptos: coinbase.CRYPTO, dev: true },
  { code: 'itbit', display: 'itBit', class: TICKER, cryptos: itbit.CRYPTO, dev: true },
  ...
  { code: 'infura', display: 'Infura', class: WALLET, cryptos: [ETH, USDT, USDC] },
  ...
  { code: 'bitstamp', display: 'Bitstamp', class: EXCHANGE, cryptos: bitstamp.CRYPTO, dev: true },
  { code: 'itbit', display: 'itBit', class: EXCHANGE, cryptos: itbit.CRYPTO, dev: true },
  { code: 'kraken', display: 'Kraken', class: EXCHANGE, cryptos: kraken.CRYPTO },
  { code: 'binance', display: 'Binance', class: EXCHANGE, cryptos: binance.CRYPTO, dev: true },
  { code: 'binanceus', display: 'Binance.us', class: EXCHANGE, cryptos: binanceus.CRYPTO, dev: true },
  { code: 'cex', display: 'CEX.IO', class: EXCHANGE, cryptos: cex.CRYPTO, dev: true },
  ...
  { code: 'mailgun', display: 'Mailgun', class: EMAIL, dev: true },
