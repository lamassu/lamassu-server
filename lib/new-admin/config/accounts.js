...
const ALL_ACCOUNTS = [
  ...
  { code: 'coinbasepro', display: 'Coinbase Pro', class: WALLET, cryptos: [BTC, BCH, DASH, ETH, LTC, USDT, ZEC] },
  ...
  { code: 'pazuz-ticker', display: 'Pazuz', class: TICKER, cryptos: [BTC], dev: true },
  { code: 'pazuz-wallet', display: 'Pazuz', class: WALLET, cryptos: [BTC], dev: true },
  { code: 'pazuz-email', display: 'Pazuz', class: EMAIL, dev: true },
  { code: 'pazuz-sms', display: 'Pazuz', class: SMS, dev: true }
]
