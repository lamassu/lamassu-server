...
const typeDef = gql`
  ...
  type Mutation {
    ...
    createMachineLocation(id: ID, label: String, addressLine1: String, addressLine2: String, zipCode: String, country: String): MachineLocation @auth
    deleteMachineLocation(locationId: ID): MachineLocation @auth
  }
`
