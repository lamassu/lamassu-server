...
const typeDef = gql`
  ...
  type Mutation {
    ...
    editMachineLocation(id: ID, label: String, addressLine1: String, addressLine2: String, zipCode: String, country: String): Boolean @auth
    createMachineLocation(id: ID, label: String, addressLine1: String, addressLine2: String, zipCode: String, country: String): Boolean @auth
    deleteMachineLocation(locationId: ID): Boolean @auth
    assignLocation(machineId: ID, locationId: ID): Boolean @auth
  }
`
