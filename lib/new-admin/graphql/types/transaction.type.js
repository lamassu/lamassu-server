...
const typeDef = gql`
  ...
  type Query {
    transactions(from: Date, until: Date, limit: Int, offset: Int, deviceId: ID, txClass: String, machineName: String, customerName: String, fiatCode: String, cryptoCode: String, toAddress: String, status: String, swept: Boolean, updatedSince: Date, excludeTestingCustomers: Boolean): [Transaction] @auth
