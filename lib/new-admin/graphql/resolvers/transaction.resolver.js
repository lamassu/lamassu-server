...
const resolvers = {
  ...
  Mutation: {
    ...
    enableTestTransaction: (...[, { txClass, id}]) => transactions.enableTestTransaction(txClass, id),
    disableTestTransaction: (...[, { txClass, id}]) => transactions.disableTestTransaction(txClass, id)
  }
}
