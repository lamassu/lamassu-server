...
const resolvers = {
  Query: {
    ...
    termsAndConditionsConfig: () => configHelper.loadTermsAndConditions(),
    triggers: () => configHelper.loadTriggers(),
    triggersConfig: () => configHelper.loadTriggersConfig(),
    walletConfig: () => configHelper.loadWallet()
  },
  Mutation: {
