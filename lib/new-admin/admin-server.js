...
const { session, buildApolloContext, findOperatorId } = require('./middlewares')

const devMode = require('minimist')(process.argv.slice(2)).dev

const HOSTNAME = process.env.HOSTNAME
const KEY_PATH = process.env.ADMIN_KEY_PATH
const CERT_PATH = process.env.ADMIN_CERT_PATH
