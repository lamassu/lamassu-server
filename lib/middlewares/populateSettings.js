...
function machineAction (type, value) {
  ...
  switch (type) {
    ...
    case 'restartServices':
      ...
      break
    case 'syncDeviceConfig':
      logger.debug(`Syncing device_config.json of machine '${deviceId}' from operator ${operatorId}`)
      state.syncDeviceConfigMap[operatorId] = { [deviceId]: pid }
      break
    default:
      break
  }
