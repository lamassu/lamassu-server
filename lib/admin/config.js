...
const ALL_CRYPTOS = ['BTC', 'ETH', 'LTC', 'DASH', 'ZEC', 'BCH', 'ADA']
  ...
  return machineLoader.getMachineNames()
    .then(machineList => ({
      ...
      cryptoCurrencies: [
        ...
        {crypto: 'ADA', display: 'Cardano'}
      ],
      languages: languages,
      countries,
      accounts: [
        {code: 'bitpay', display: 'Bitpay', class: 'ticker', cryptos: ['BTC', 'BCH']},
        {code: 'kraken', display: 'Kraken', class: 'ticker', cryptos: ['BTC', 'ETH', 'LTC', 'DASH', 'ZEC', 'BCH', 'ADA']},
        {code: 'bitstamp', display: 'Bitstamp', class: 'ticker', cryptos: ['BTC', 'ETH', 'LTC', 'BCH']},
        {code: 'coinbase', display: 'Coinbase', class: 'ticker', cryptos: ['BTC', 'ETH', 'LTC', 'BCH', 'ZEC']},
        ...
        {code: 'kraken', display: 'Kraken', class: 'exchange', cryptos: ['BTC', 'ETH', 'LTC', 'DASH', 'ZEC', 'BCH', 'ADA']},
        ...
        {code: 'all-zero-conf', display: 'Always 0-conf', class: 'zeroConf', cryptos: ['BTC', 'ZEC', 'LTC', 'DASH', 'BCH', 'ADA']},
        ...
        {code: 'cardano', display: 'Caradano', class: 'wallet', cryptos: ['ADA']}
      ],
