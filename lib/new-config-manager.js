...
const getCashOutConstraints = (cryptoCode, settings) => {
  const CASH_IN_ONLY_WALLETS = ['coinbasepro']
  return _.includes(getWalletSettings(cryptoCode, settings).wallet, CASH_IN_ONLY_WALLETS)
}
