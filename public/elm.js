...
var _user$project$FieldSetTypes$Field = F5(
	function (a, b, c, d, e) {
		return {code: a, display: b, required: c, value: d, loadedValue: e};
	});
var _user$project$FieldSetTypes$PasswordHidden = {ctor: 'PasswordHidden'};
var _user$project$FieldSetTypes$PasswordEmpty = {ctor: 'PasswordEmpty'};
var _user$project$FieldSetTypes$Password = function (a) {
	...
	function (stringValue, oldFieldValue) {
		...
		if (_p0.ctor === 'FieldString') {
			...
			return _user$project$FieldSetTypes$FieldPassword(
				_user$project$FieldSetTypes$Password(stringValue));
		}
	});
...
var _user$project$FieldSetDecoder$fieldPasswordDecoder = function (present) {
	return present ? _user$project$FieldSetTypes$FieldPassword(_user$project$FieldSetTypes$PasswordHidden) : _user$project$FieldSetTypes$FieldPassword(_user$project$FieldSetTypes$PasswordEmpty);
};
var _user$project$FieldSetDecoder$fieldValueDecoder = function (fieldType) {
	...
	switch (_p0) {
		...
		case 'password':
			return A2(_elm_lang$core$Json_Decode$map, _user$project$FieldSetDecoder$fieldPasswordDecoder, _elm_lang$core$Json_Decode$bool);
		default:
...
var _user$project$FieldSetEncoder$encodeField = function (field) {
	...
	return _user$project$FieldSetEncoder$isDirty(field) ? _elm_lang$core$Maybe$Just(
			...
			_1: {
				...
				_1: {
					...
					_0: {
						...
						_0: 'fields',
						_1: _elm_lang$core$Json_Encode$list(
							A2(_elm_lang$core$List$filterMap, _user$project$FieldSetEncoder$encodeField, account.fields))
					},
					_1: {ctor: '[]'}
				}
			}
		...
		switch (_p6.ctor) {
			...
			default:
				...
				var updateFields = function (model) {
					return A2(_user$project$FieldSet$update, _p6._0, model.account.fields);
				};
...
var _user$project$ConfigTypes$fieldHolderToCryptoStrings = function (fieldHolder) {
	...
	if (_p3.ctor === 'FieldOk') {
		var _p4 = _p3._0;
		if (_p4.ctor === 'FieldCryptoCurrencyValue') {
			return _p4._0;
		} else {
			return {ctor: '[]'};
		}
...
var _user$project$ConfigTypes$isCrypto = F2(
	function (cryptoString, cryptoDisplay) {
		var _p5 = cryptoDisplay.crypto;
		if (_p5.ctor === 'GlobalCrypto') {
			return _elm_lang$core$Native_Utils.eq(cryptoString, 'global');
		} else {
			return _elm_lang$core$Native_Utils.eq(cryptoString, _p5._0);
		}
	});
...
var _user$project$StatusTypes$ServerRec = F3(
	function (a, b, c) {
		return {up: a, lastPing: b, rates: c};
	});
...
var _user$project$Config$initFieldInstance = F3(
	function (configGroup, fieldDescriptor, fieldScope) {
		...
		return {fieldLocator: fieldLocator, component: component, fieldHolder: fieldHolder, loadedFieldHolder: fieldHolder, fieldValidation: fieldDescriptor.fieldValidation, fieldEnabledIf: fieldDescriptor.fieldEnabledIf};
	});
...
var _user$project$Config$topHeaderRowView = F2(
	function (configGroup, crypto) {
		var headerCellView = function (fieldDescriptor) {
			var _p13 = fieldDescriptor.displayTop;
			switch (_p13.ctor) {
				case 'DisplayTopLeader':
					return _elm_lang$core$Maybe$Just(
						A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$colspan(_p13._0),
								_1: {
									ctor: '::',
									_0: _user$project$Css_Admin$class(
										{
...
var _user$project$Config$validateRequired = F2(
	function (fieldInstances, fieldInstance) {
...
var _user$project$Config$validate = F3(
	function (fieldInstances, fieldInstance, fieldValidator) {
		var _p14 = fieldValidator;
		switch (_p14.ctor) {
			case 'FieldRequired':
				return A2(_user$project$Config$validateRequired, fieldInstances, fieldInstance);
			case 'FieldMin':
				return A3(
					_user$project$ConfigTypes$fieldHolderMap,
					true,
					_user$project$Config$validateMin(_p14._0),
					fieldInstance.fieldHolder);
			default:
				return A3(
					_user$project$ConfigTypes$fieldHolderMap,
					true,
					_user$project$Config$validateMax(_p14._0),
					fieldInstance.fieldHolder);
		}
	});
...
var _user$project$Config$validateFieldInstance = F3(
	function (configGroup, fieldInstances, fieldInstance) {
		var isRequired = A2(_elm_lang$core$List$member, _user$project$ConfigTypes$FieldRequired, fieldInstance.fieldValidation);
		var fieldScope = fieldInstance.fieldLocator.fieldScope;
		var isEnabled = A4(_user$project$Config$checkEnabled, fieldInstances, configGroup, fieldInstance.fieldEnabledIf, fieldScope);
		return (!isEnabled) || A2(
			_elm_lang$core$List$all,
			A2(_user$project$Config$validate, fieldInstances, fieldInstance),
...
var _user$project$Config$fieldTypeToInputType = function (fieldType) {
	var _p28 = fieldType;
	if (_p28.ctor === 'FieldPercentageType') {
		return 'number';
	} else {
		return 'string';
	}
...
var _user$project$Config$fieldHolderToList = function (fieldHolder) {
	var _p29 = fieldHolder;
	if (_p29.ctor === 'FieldOk') {
		var _p30 = _p29._0;
		switch (_p30.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.crashCase(
					'Config',
					{
						...
						end: {line: 152, column: 50}
					},
					_p30)('Not a list type');
		}
	} else {
		return {ctor: '[]'};
	}
...
var _user$project$Config$updateStringFieldInstance = F4(
	function (fieldInstances, fieldLocator, maybeString, fieldInstance) {
		if (_elm_lang$core$Native_Utils.eq(fieldInstance.fieldLocator, fieldLocator)) {
			var _p32 = fieldLocator.fieldType;
			switch (_p32.ctor) {
				case 'FieldLanguageType':
				...
				default:
					var fieldHolder = function () {
						...
						if (_p35.ctor === 'Nothing') {
							...
							return A2(_user$project$ConfigTypes$stringToFieldHolder, fieldLocator.fieldType, _p35._0);
						}
					}();
					return _elm_lang$core$Native_Utils.update(
						fieldInstance,
...
var _user$project$Config$updateInput = F3(
	function (fieldLocator, maybeValueString, model) {
		var oldFieldInstances = model.fieldInstances;
...
var _user$project$Config$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {webConfigGroup: a, fieldInstances: b, crypto: c, fiat: d, status: e, focused: f, rates: g};
	});
...
var _user$project$Config$selectizeView = F6(
	function (model, fieldInstance, selectizeState, maybeFieldValue, maybeFallbackFieldValue, enabled) {
		...
		var _p38 = fieldLocator.fieldType;
		switch (_p38.ctor) {
			case 'FieldAccountType':
...
var _user$project$Config$cryptoView = F2(
	function (maybeActiveCrypto, cryptoDisplay) {
		var activeClass = function () {
			var _p40 = maybeActiveCrypto;
			if (_p40.ctor === 'Nothing') {
				return _user$project$Css_Admin$class(
					{ctor: '[]'});
			} else {
				return _elm_lang$core$Native_Utils.eq(_p40._0, cryptoDisplay.crypto) ? _user$project$Css_Admin$class(
					{
						ctor: '::',
...
var _user$project$Config$fieldInput = F5(
	function (model, fieldInstance, maybeFieldValue, maybeFallbackFieldValue, enabled) {
		var _p41 = fieldInstance.component;
		if (_p41.ctor === 'InputBoxComponent') {
			return A5(_user$project$Config$textInput, model.fiat, fieldInstance, maybeFieldValue, maybeFallbackFieldValue, enabled);
		} else {
			return A6(_user$project$Config$selectizeView, model, fieldInstance, _p41._0, maybeFieldValue, maybeFallbackFieldValue, enabled);
		}
	});
var _user$project$Config$fieldComponent = F2(
	function (model, fieldInstance) {
		...
		var fieldInstances = model.fieldInstances;
		var fieldValid = A3(_user$project$Config$validateFieldInstance, configGroup, fieldInstances, fieldInstance);
		var fieldLocator = fieldInstance.fieldLocator;
...
var _user$project$Config$submitNoLoad = function (model) {
	...
	if (_p48.ctor === 'Success') {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_user$project$Config$postFormNoLoad, _p48._0.schema.code, model.fieldInstances),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
...
var _user$project$Config$submit = function (model) {
	...
	if (_p49.ctor === 'Success') {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_user$project$Config$postForm, _p49._0.schema.code, model.fieldInstances),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
			...
			case 'Load':
				...
				var fieldInstances = function () {
					...
					if (_p55.ctor === 'Success') {
						return _user$project$Config$initFieldInstances(_p55._0);
					} else {
						return {ctor: '[]'};
					}
				}();
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{webConfigGroup: _p57, fieldInstances: fieldInstances, status: status, crypto: crypto, fiat: fiat}),
					_1: cmd
				};
			case 'Submit':
						...
						_0: A2(
							...
							},
							{
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data', _p0._0),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
		...
		switch (_p1.ctor) {
			case 'Load':
				...
				var _p2 = A2(
					...
					'TOTEM',
					A2(_krisajenkins$remotedata$RemoteData$withDefault, 'Network Error', _p3));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
...
var _user$project$Machine$toModel = F2(
...
var _user$project$Machine$SubModel = F2(
	function (a, b) {
		return {status: a, machines: b};
	});
var _user$project$Machine$NotSaving = {ctor: 'NotSaving'};
var _user$project$Machine$Editing = {ctor: 'Editing'};
var _user$project$Machine$Saved = {ctor: 'Saved'};
var _user$project$Machine$Saving = {ctor: 'Saving'};
var _user$project$Machine$HideSaveIndication = {ctor: 'HideSaveIndication'};
var _user$project$Machine$saveUpdate = function (model) {
	var cmd = _elm_lang$core$Native_Utils.eq(model.status, _user$project$Machine$Saved) ? A2(
		_elm_lang$core$Task$perform,
		function (_p3) {
			return _user$project$Machine$HideSaveIndication;
		},
		_elm_lang$core$Process$sleep(2 * _elm_lang$core$Time$second)) : _elm_lang$core$Platform_Cmd$none;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
	...
	A2(
		...
		function (_p4) {
			return _krisajenkins$remotedata$RemoteData$fromResult(
				A2(
					_elm_lang$core$Result$map,
					_user$project$Machine$toModel(_user$project$Machine$NotSaving),
					_p4));
		},
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
		...
		A2(
			...
			function (_p5) {
				return _krisajenkins$remotedata$RemoteData$fromResult(
					A2(
						_elm_lang$core$Result$map,
						_user$project$Machine$toModel(_user$project$Machine$Saved),
						_p5));
			},
			A2(
				_lukewestby$elm_http_builder$HttpBuilder$withExpect,
		...
		switch (_p6.ctor) {
			case 'Action':
				return A2(
					...
					{ctor: '[]'});
			case 'Load':
				return A2(_krisajenkins$remotedata$RemoteData$update, _user$project$Machine$saveUpdate, _p6._0);
			case 'InputCassette':
				return A2(
					_krisajenkins$remotedata$RemoteData$update,
					A3(_user$project$Machine$updateCassette, _p6._0, _p6._1, _p6._2),
					model);
			case 'SubmitResetBills':
				return A2(
					_krisajenkins$remotedata$RemoteData$update,
					_user$project$Machine$updateSubmitCassette(_p6._0),
					model);
			default:
				return A2(
					_krisajenkins$remotedata$RemoteData$update,
					function (subModel) {
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								subModel,
								{status: _user$project$Machine$NotSaving}),
							{ctor: '[]'});
					},
					model);
		}
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Machine$tableView(_p9.machines),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$html$Html$div,
...
var _user$project$NavBar$view = F2(
	function (route, invalidGroups) {
		var allClear = _elm_lang$core$List$isEmpty(invalidGroups);
					...
					_1: {
						...
						_0: A2(
							ll,
							{
								...
								_2: A2(_user$project$CoreTypes$ConfigRoute, 'fiat', _elm_lang$core$Maybe$Nothing),
								_3: allClear
							},
							{
								ctor: '::',
...
var _user$project$StatusDecoder$serverDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p11.ctor) {
			case 'PairMsg':
				var _p12 = A2(_user$project$Pair$update, _p11._0, model.pair);
			...
			case 'LoadStatus':
				var newStatus = _elm_lang$core$List$head(
					A2(
						...
						{
							ctor: '::',
							_0: _krisajenkins$remotedata$RemoteData$toMaybe(_p11._0),
							_1: {
								ctor: '::',
								_0: model.status,
								_1: {ctor: '[]'}
				...
				return A2(
					...
					{ctor: '[]'});
			case 'NewUrl':
				var _p18 = _user$project$Config$submitNoLoad(model.config);
				var configModel = _p18._0;
				var configCmd = _p18._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			case 'UrlChange':
				return A2(_user$project$Main$urlUpdate, _p11._0, model);
			default:
				var route = A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$CoreTypes$NotFoundRoute,
