			...
			if (_elm_lang$core$Native_Utils.eq(fieldInstance.fieldLocator, fieldLocator)) {
				...
				if (_p3.ctor === 'SelectizeComponent') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Config',
						{
							start: {line: 1086, column: 17},
							end: {line: 1091, column: 56}
						},
...
var _user$project$Config$isField = function (fieldValue) {
	...
	if (_p9.ctor === 'FieldOnOffValue') {
		...
		return _elm_lang$core$Native_Utils.crashCase(
			'Config',
			{
				start: {line: 926, column: 5},
				end: {line: 931, column: 59}
			},
			...
			if (_p14.ctor === 'Nothing') {
				...
				if (_p15.ctor === 'FieldLanguageValue') {
					...
					return _elm_lang$core$Native_Utils.crashCase(
						'Config',
						{
							start: {line: 509, column: 21},
							end: {line: 514, column: 60}
						},
		...
		switch (_p36.ctor) {
			...
			default:
				return _elm_lang$core$Native_Utils.crashCase(
					'Config',
					{
						start: {line: 552, column: 9},
						end: {line: 594, column: 52}
					},
